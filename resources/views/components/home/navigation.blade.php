<div x-data="{ open:false }" class="w-full z-50">
    <div class="w-full h-20 flex items-center justify-center" :class="{'block': ! open, 'hidden': open}">
        <x-body class="w-full text-white text-xs">
