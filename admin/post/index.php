                        ...
                        $query = "SELECT posts.*, categories.name AS category_name FROM posts LEFT JOIN categories ON posts.cat_id = categories.id;";
                         ...
                         foreach ($posts as $key => $post) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= url('admin/post/change-status.php?post_id=' . $post->id) ?>" class="btn btn-block btn-warning btn-sm">Change status</a>
                                    <a href="<?= url('admin/post/edit.php?post_id=' . $post->id) ?>" class="btn btn-block btn-info btn-sm">Edit</a>
                                    <a href="<?= url('admin/post/delete.php?post_id=' . $post->id) ?>" class="btn btn-block btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            <?php } ?>
