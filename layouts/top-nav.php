...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary bg-gradient">
    ...
    <a class="navbar-brand" i href="#"> <img src="./sabimages/Sabi ride 2.png" width="100px" alt=""></a>
    ...
    <section class="d-inline ">
        ...
        <a class="text-decoration-none text-white px-2 " href="auth/logout.php">logout</a>
