                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Ride-hailing is a transportation service that allows passengers to request a ride from a location using a mobile app, connecting them with drivers who use their own vehicles to provide the service.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
