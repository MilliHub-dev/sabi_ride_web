...
<head>
    ...
    <!-- <link rel="stylesheet" href="../style/sabi_verification2.css"> -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="row g-3 ms-5 justify-content-start">
                <div class="row justify-content-start">
                    <p class="fw-nowrap col-6 fw-bold text-start  ">Private and licenseing details</p>
                </div>
                ...
                <input type="hidden" name="vehicle_color" value="<?php echo htmlspecialchars($_POST['vehicle_color']); ?>"> -->
                    <div class="mb-3">
                        ...
                        <input type="text" name="driver_license_number" class="form-control" id="driver_license_number" autofocus required>
                        <p>Enter Driver's License number</p>
                    </div>
                    <div mb-3>
