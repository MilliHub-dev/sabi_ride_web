            ...
            <div>
                <div class="row mt-3 justify-content-center">
                    ...
                    <div class="col-12">
                        <form action="sabi_verification3.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <input type="text" name="driver_license_number" placeholder="License number" class="form-control center-flex-elem" id="driver_license_number" autofocus required>
                    ...
                    <div class="mb-3 col-12">
                        ...
                        <input type="date" id="driver_license_expiry" class="form-control text-center w-50 m-auto" name="driver_license_expiry" required>
                    </div>
